	...
	<div id="primary" class="content-area">
		...
		<div class="container-fluid">
			...
			<div class="row pic-card-container">
				<div class="col-sm-6 col-xs-12 pic-card">
					<div class="pic-card-content col-sm-6">
					...
					<div class="pic-card-image hidden-xs col-sm-6">
			...
			<div class="row services">
				<h4 class="col-xs-offset-1 services-title"><b>Our Services</b></h4>
				<div class="services-container">
				<div class=" col-sm-offset-1 col-sm-2 col-xs-6 text-center service-container hidden-xs">
				...
				<div class="col-sm-2 col-xs-6 text-center service-container hidden-xs">
